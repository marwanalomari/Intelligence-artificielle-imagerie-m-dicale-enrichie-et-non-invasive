...
def main():
    batch_size=1
    test_path='E:/Marwan/128x128cropped/npy_test/test_T18T28F.npy'
    ...
    seed_torch()
    file_path='E:/Marwan/128x128cropped/npy_gan/gan_T18T28F.npy'
    ...
    discriminator=netD()
    unet = Unet()
    unet.load_state_dict(torch.load("E:/Marwan/128x128cropped/Weights/unet_miso_t.pth"))
    ...
    for epoch in range(EPOCH):
        ...
        log.to_csv('E:/Marwan/128x128cropped/Weights/loggan_miso_f.csv', index=False)
    ...
    model_save_g='E:/Marwan/128x128cropped/Weights/miso_f_generator_t2_tumor_bw.pth'
    torch.save(generator.state_dict(), model_save_g)
    model_save_s='E:/Marwan/128x128cropped/Weights/miso_f_segmentor_t2_tumor_bw.pth'
    torch.save(unet.state_dict(), model_save_s)
    model_save_d='E:/Marwan/128x128cropped/Weights/miso_f_discriminator_t2_bw.pth'
