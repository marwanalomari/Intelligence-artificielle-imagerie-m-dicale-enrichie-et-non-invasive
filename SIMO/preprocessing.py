...
import pandas as pd
 ...
 # loading data
file_path_flair=glob.glob('E:/Marwan/SIMO/dataset/**/*_flair.nii',recursive=True)
file_path_seg=glob.glob('E:/Marwan/SIMO/dataset/**/*_seg.nii',recursive=True)
file_path_t1=glob.glob('E:/Marwan/SIMO/dataset/**/*_t1.nii',recursive=True)
file_path_t1ce=glob.glob('E:/Marwan/SIMO/dataset/**/*_t1ce.nii',recursive=True)
file_path_t2=glob.glob('E:/Marwan/SIMO/dataset/**/*_t2.nii',recursive=True)
data_path = []
...
np.save('E:/Marwan/SIMO/npy_train/train_flair.npy',flair)
np.save('E:/Marwan/SIMO/npy_train/train_t1.npy',t1)
np.save('E:/Marwan/SIMO/npy_train/train_t1ce.npy',t1ce)
np.save('E:/Marwan/SIMO/npy_train/train_t2.npy',t2)
np.save('E:/Marwan/SIMO/npy_train/train_seg.npy',seg)
print("Done preprocessing train")
...
np.save('E:/Marwan/SIMO/npy_test/test_flair.npy',flair)
np.save('E:/Marwan/SIMO/npy_test/test_t1.npy',t1)
np.save('E:/Marwan/SIMO/npy_test/test_t1ce.npy',t1ce)
np.save('E:/Marwan/SIMO/npy_test/test_t2.npy',t2)
np.save('E:/Marwan/SIMO/npy_test/test_seg.npy',seg)
print("Done preprocessing test")
...
np.save('E:/Marwan/SIMO/npy_gan/gan_flair.npy',flair)
np.save('E:/Marwan/SIMO/npy_gan/gan_t1.npy',t1)
np.save('E:/Marwan/SIMO/npy_gan/gan_t1ce.npy',t1ce)
np.save('E:/Marwan/SIMO/npy_gan/gan_t2.npy',t2)
np.save('E:/Marwan/SIMO/npy_gan/gan_seg.npy',seg)

print('Done processing Gan')